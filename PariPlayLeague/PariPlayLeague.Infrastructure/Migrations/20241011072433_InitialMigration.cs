        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Champion_Range", "[Champion] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GoalsAwayTeam_Range", "[GoalsAwayTeam] >= 0");
                    table.CheckConstraint("CK_GoalsHomeTeam_Range", "[GoalsHomeTeam] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamsSeasons", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsidedGoals = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamsStatistics", x => x.TeamSeasonId);
                    table.ForeignKey(
                        name: "FK_TeamsStatistics_TeamsSeasons_TeamSeasonId",
